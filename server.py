...
CORS(app, resources={r"/get_predefined_voices": {"origins": CORS_ALLOWED_ORIGIN}})
...
def get_predefined_voices_api():
    ...
    try:
        response = jsonify([{"display_name": voice, "filename": voice} for voice in SUPPORTED_VOICES])
        return response
